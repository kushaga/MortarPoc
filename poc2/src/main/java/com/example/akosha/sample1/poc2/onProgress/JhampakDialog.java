package com.example.akosha.sample1.poc2.onProgress;
...
public class JhampakDialog {
    ...
    private MyJhampakView myJhampakView;
    ...
    final void showView() {
        ...
        myJhampakView = (MyJhampakView) this.mView.findViewById(R.id.jhampak_view);
        myJhampakView.startAnimation();
...
//        }
    ...
    private void animateChildrenIn(int delay, int duration) {
        ViewCompat.setAlpha(myJhampakView, 0.0F);
        ViewCompat.animate(myJhampakView).alpha(1.0F).setDuration((long) duration).setStartDelay((long) delay).start();
    }

    private void animateChildrenOut(int delay, int duration) {
        ViewCompat.setAlpha(myJhampakView, 1.0F);
        ViewCompat.animate(myJhampakView).alpha(0.0F).setDuration((long) duration).setStartDelay((long) delay).start();
    }
