 ...
 */
public class MyJhampakView extends LinearLayout {
    ...
    public MyJhampakView(Context context) {
        super(context);
        init(context);
    }

    public MyJhampakView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MyJhampakView(Context context, AttributeSet attrs, int defStyleAttr) {
